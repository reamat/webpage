...
'''
Constroi o hotsite reamat/PreCalculo.
...
nomeDoRecurso = "Pré-cálculo"
nomeDoRepo = "PreCalculo"
...
<ul class="list-unstyled">\
<li><a href="https://github.com/reamat/PreCalculo"\
target="_blank">\
https://github.com/reamat/PreCalculo</a></li>\
</ul>'
...
print("Congratulations! ./PreCalculo/mkhs.py ended successfully. :)")
